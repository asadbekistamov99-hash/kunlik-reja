...
class HabitEngine(private val habitDao: HabitDao) {
    ...
    companion object {
        ...
        fun titleFromStatement(statement: String): String {
            // Drop time/day phrases ("7 da", "ertalab", "dushanba kuni") so they don't end up in the title.
            val withoutTime = CommandParser { LocalDateTime.of(2000, 1, 1, 0, 0) }.parse(statement).remainder
            val words = withoutTime.lowercase(Locale.ROOT)
