...
class JarvisKeywordModel(
    ...
    companion object {
        ...
        fun load(context: Context): JarvisKeywordModel {
            ...
            return JarvisKeywordModel(env, session(MEL_MODEL), session(EMBEDDING_MODEL), session(KEYWORD_MODEL))
        }
    }
}
